...
suite('the whole extension', () => {
	test('single line', async () => {
		...
		const commands: Action[] = [
			...
			{ kind: 'Command', command: 'change-stepper.next-token', expectedResult: 'Hello' },
			{ kind: 'Command', command: 'change-stepper.previous-token', expectedResult: '' },
			// Should not be able to go past the start
			{ kind: 'Command', command: 'change-stepper.previous-token', expectedResult: '' },
			{ kind: 'Command', command: 'change-stepper.previous-token', expectedResult: '' },
			{ kind: 'Command', command: 'change-stepper.next-token', expectedResult: 'Hello' },
			{ kind: 'Command', command: 'change-stepper.next-token', expectedResult: 'Hello World' },
			{ kind: 'Command', command: 'change-stepper.next-token', expectedResult: 'Hello World, ' },
			{ kind: 'Command', command: 'change-stepper.next-token', expectedResult: 'Hello World, this' },
			{ kind: 'Command', command: 'change-stepper.next-token', expectedResult: 'Hello World, this is' },
			{ kind: 'Command', command: 'change-stepper.next-token', expectedResult: 'Hello World, this is a' },
			{ kind: 'Command', command: 'change-stepper.next-token', expectedResult: 'Hello World, this is a test' },
			// Should not be able to go past the end
			{ kind: 'Command', command: 'change-stepper.next-token', expectedResult: 'Hello World, this is a test' },
			{ kind: 'Command', command: 'change-stepper.next-token', expectedResult: 'Hello World, this is a test' },
			// From anywhere, previous line should go to the start
			{ kind: 'Command', command: 'change-stepper.previous-token', expectedResult: 'Hello World, this is a' },
			{ kind: 'Command', command: 'change-stepper.previous-token', expectedResult: 'Hello World, this is' },
			{ kind: 'Command', command: 'change-stepper.previous-token', expectedResult: 'Hello World, this' },
			{ kind: 'Command', command: 'change-stepper.previous-line', expectedResult: '' },
			{ kind: 'Command', command: 'change-stepper.previous-line', expectedResult: '' },
			{ kind: 'Command', command: 'change-stepper.next-line', expectedResult: 'Hello World, this is a test' },
			{ kind: 'Command', command: 'change-stepper.previous-line', expectedResult: '' },
			...
			{ kind: 'Command', command: 'change-stepper.next-token', expectedResult: 'Hello World, this is my test' },
			{ kind: 'Command', command: 'change-stepper.previous-token', expectedResult: 'Hello World, this is my test' },
			{ kind: 'Command', command: 'change-stepper.previous-line', expectedResult: 'Hello World, this is my test' },
			{ kind: 'Command', command: 'change-stepper.next-line', expectedResult: 'Hello World, this is my test' },
		];
	...
	test('multi line', async () => {
		...
		const actions: Action[] = [
			...
			{ kind: 'Command', command: 'change-stepper.next-token', expectedResult: 'now' },
			{ kind: 'Command', command: 'change-stepper.next-token', expectedResult: 'now doing\n' },
			{ kind: 'Command', command: 'change-stepper.next-token', expectedResult: 'now doing\na' },
			{ kind: 'Command', command: 'change-stepper.next-token', expectedResult: 'now doing\na multiline' },
			{ kind: 'Command', command: 'change-stepper.next-token', expectedResult: 'now doing\na multiline test\n' },
			{ kind: 'Command', command: 'change-stepper.next-token', expectedResult: 'now doing\na multiline test\nwith\n' },
			...
			{ kind: 'Command', command: 'change-stepper.next-token', expectedResult: 'now doing\na multiline test\nwith\nvarying number of words' },
			{ kind: 'Command', command: 'change-stepper.next-token', expectedResult: 'now doing\na multiline test\nwith\nvarying number of words' },
			{ kind: 'Command', command: 'change-stepper.previous-token', expectedResult: 'now doing\na multiline test\nwith\nvarying number of' },
			{ kind: 'Command', command: 'change-stepper.previous-token', expectedResult: 'now doing\na multiline test\nwith\nvarying number' },
			{ kind: 'Command', command: 'change-stepper.previous-token', expectedResult: 'now doing\na multiline test\nwith\nvarying' },
			{ kind: 'Command', command: 'change-stepper.previous-token', expectedResult: 'now doing\na multiline test\nwith\n' },
			{ kind: 'Command', command: 'change-stepper.previous-token', expectedResult: 'now doing\na multiline test\n' },
			...
			{ kind: 'Command', command: 'change-stepper.previous-token', expectedResult: 'now doing\na' },
			{ kind: 'Command', command: 'change-stepper.previous-token', expectedResult: 'now doing\n' },
			{ kind: 'Command', command: 'change-stepper.previous-token', expectedResult: 'now' },
			// Should not be able to go past the start
			{ kind: 'Command', command: 'change-stepper.previous-token', expectedResult: '' },
			{ kind: 'Command', command: 'change-stepper.previous-token', expectedResult: '' },
			// From anywhere, previous line should go to the start of the line
			{ kind: 'Command', command: 'change-stepper.next-line', expectedResult: 'now doing\n' },
			{ kind: 'Command', command: 'change-stepper.next-line', expectedResult: 'now doing\na multiline test\n' },
			{ kind: 'Command', command: 'change-stepper.next-line', expectedResult: 'now doing\na multiline test\nwith\n' },
			{ kind: 'Command', command: 'change-stepper.next-token', expectedResult: 'now doing\na multiline test\nwith\nvarying' },
			{ kind: 'Command', command: 'change-stepper.previous-line', expectedResult: 'now doing\na multiline test\nwith\n' },
			{ kind: 'Command', command: 'change-stepper.previous-line', expectedResult: 'now doing\na multiline test\n' },
			{ kind: 'Command', command: 'change-stepper.previous-line', expectedResult: 'now doing\n' },
			{ kind: 'Command', command: 'change-stepper.next-line', expectedResult: 'now doing\na multiline test\n' },
			{ kind: 'Command', command: 'change-stepper.next-line', expectedResult: 'now doing\na multiline test\nwith\n' },
